  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-[#3E2723]">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
        ...
        {/* TEXT + CTA */}
        <div
          className={`mt-12 text-cream max-w-2xl mx-auto transition-all duration-1000 delay-1000 ${
        ...
        >
          ...
          <a
            href="#"
            className="inline-block border-2 border-cream text-cream px-8 py-3 font-bold uppercase tracking-widest hover:bg-cream hover:text-[#3E2723] transition-colors duration-300"
          >

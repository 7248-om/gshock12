...
//   title: string;
//   description: string;
//   date: string; // use string for simplicity, can convert to Date
//   time: string;
//   price: number; // 0 = free
// };
...
//   { id: 1, title: "Latte Art Basics", description: "Learn milk frothing & latte art.", date: "2026-01-25", time: "16:00 – 18:00", price: 799 },
//   { id: 2, title: "Espresso Masterclass", description: "Espresso extraction techniques.", date: "2026-01-28", time: "17:00 – 19:00", price: 999 },
//   { id: 3, title: "Pour-Over Techniques", description: "Master pour-over brewing.", date: "2026-01-30", time: "15:00 – 17:00", price: 899 },
//   { id: 4, title: "Cold Brew Workshop", description: "Make delicious cold brew.", date: "2026-02-01", time: "14:00 – 16:00", price: 0 },
//   { id: 5, title: "Coffee Tasting", description: "Taste and differentiate coffee beans.", date: "2026-02-02", time: "17:00 – 19:00", price: 499 },
//   { id: 6, title: "Home Brewing Tips", description: "Brew coffee at home like a pro.", date: "2026-02-03", time: "16:00 – 18:00", price: 0 },
//   { id: 7, title: "French Press Secrets", description: "Perfect French press coffee.", date: "2026-02-05", time: "15:00 – 17:00", price: 699 },
//   { id: 8, title: "Cupping Session", description: "Learn professional coffee cupping.", date: "2026-02-06", time: "16:00 – 18:00", price: 0 },
//   { id: 9, title: "Latte Art Advanced", description: "Advanced latte art techniques.", date: "2026-02-07", time: "17:00 – 19:00", price: 1099 },
//   { id: 10, title: "Aeropress Techniques", description: "Master Aeropress brewing.", date: "2026-02-08", time: "14:00 – 16:00", price: 599 },
//   { id: 11, title: "Coffee & Dessert Pairing", description: "Pair coffee with desserts.", date: "2026-02-09", time: "15:00 – 17:00", price: 0 },
//   { id: 12, title: "Advanced Espresso", description: "Professional espresso skills.", date: "2026-02-10", time: "16:00 – 18:00", price: 1299 },
//   { id: 13, title: "Brewing Science", description: "Learn coffee chemistry & extraction.", date: "2026-02-11", time: "17:00 – 19:00", price: 0 },
//   { id: 14, title: "Coffee Latte Workshop", description: "Classic latte brewing.", date: "2026-02-12", time: "15:00 – 17:00", price: 799 },
//   { id: 15, title: "Coffee Art for Kids", description: "Fun coffee-inspired art for kids.", date: "2026-02-13", time: "14:00 – 15:30", price: 0 },
//   { id: 16, title: "Coffee Roasting 101", description: "Basics of roasting coffee beans.", date: "2026-02-14", time: "16:00 – 18:00", price: 899 },
//   { id: 17, title: "Barista Skills", description: "Become a pro barista.", date: "2026-02-15", time: "17:00 – 19:00", price: 1199 },
//   { id: 18, title: "Coffee & Chocolate Pairing", description: "Pair coffee with chocolates.", date: "2026-02-16", time: "15:00 – 17:00", price: 0 },
//   { id: 19, title: "Iced Coffee Creations", description: "Make creative iced coffee drinks.", date: "2026-02-17", time: "14:00 – 16:00", price: 599 },
//   { id: 20, title: "Coffee History & Culture", description: "Learn coffee origins & culture.", date: "2026-02-18", time: "16:00 – 18:00", price: 0 },
// ];
...
//       <h1 className="text-4xl font-bold text-center mb-4">☕ Coffee Rabusta Workshops</h1>
//       <p className="text-center text-gray-600 mb-8">
//         Learn coffee brewing from our expert baristas
//       </p>
...
//           <div key={w.id} className="bg-white rounded-xl shadow-md p-6 flex flex-col justify-between">
//             <div>
...
//               <p className={`text-sm font-medium mt-2 ${w.price === 0 ? "text-green-600" : "text-gray-900"}`}>
